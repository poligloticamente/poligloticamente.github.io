...
### <a name="instalar"></a>O começo - instalando!
...
### <a name="deckscompartilhados"></a>[Baralhos compartilhados - Ankiweb.net](https://ankiweb.net/shared/decks/)
...
### <a name="estatisticas"></a>Estatísticas

Não passam de números. Porém, são números bem interessantes, caso você esteja buscando uma maneira de contabilizar,
medir o aprendizado. Claro que nem sempre isso é necessário, principalmente se você está com tesão para estudar e aprender.

Mas sem tesão, a coisa fica complicada, e a motivação entra em baixa. Nesses casos, os números nas estatísticas pode
sim te ajudar a permanecer na trilha.

Para acessar as estatísticas, (além de estudar) basta clicar no [botãozinho lá no canto direito superior](#interface).
O Anki gera uma sequência pesada de estísticas. Em outros programas esse tipo de número só está disponível para quem
paga por uma conta *premium*.
Como o programa gera tantos gráficos auto-explicativos, não vou ficar falando sobre cada um. Acho que chega até a ser
divertido estudar, e ver os gráficos e números flutuando e mundando.
Porém, olha só essa imagem:

![Tipos de cartas no Anki](/imgs/Anki-tipos-de-cartao.png)

A imagem acima mostra apenas um pedacinho do que o Anki mostra, mas resolvi colocar pois uso bastante.
Esse é um baralho bem grandinho (contém os 2200 kanjis que alguém que terminou a escola no Japão deveria saber).
Quando tem tanta coisa é facil perder o foco. Nesse caso, vou lá nas estatísticas e analiso, será que o meu estudo
realmente tá rendendo? Os números mostram que mal cheguei na metade do baralho, mas na prática sei que to aprendendo.
Então, estou focando em *amadurecer* as cartas (ao invés de aprender novas). Uma carta amadurecida, - nesse caso - é
uma carta que consegui lembrar dela mesmo depois de mais de 21 dias. o/ 

### <a name="configs"></a>Configurações avançadas

Existem tantas configurações e possibilidades no Anki que, quanto mais penso, mais sinto que este artigo está incompleto.
Porém vou deixar esta seção em aberto, e vou adicionando aqui outros artigos que mostram como poder tirar o melhor
proveito possível do Anki.

### <a name="concluindo"></a>Conclusão

Este artigo segue em aberto e será editado conforme for necessário.
O Anki não é a solução para todos os seus problemas, mas pode dar uma forcinha.
Neste artigo, a ideia é dar uma pincelada geral sobre o programa, e não entrar em muito detalhe e cobrir todos os 
buracos. Portanto, se alguma ficou faltando, comente! Assim podemos atualizar o artigo e outras pessoas terão acesso
a uma informação melhor e mais organizada.
Se você tem alguma dúvida, sugestão ou informação: compartilhe! Pois o Poligloticamente existe justamente para servir
de ponte no aprendizado de outras línguas.
